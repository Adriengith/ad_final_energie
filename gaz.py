...
def donnees_gaz_2008_2017():
    for annee in range(2008,2018,1):
        df = pd.read_csv(f'data/gaz/donnees_gaz_{annee}.csv', sep = ';', encoding='latin-1')
        inc = 0
        # print(annee)
        # print(len(df))
        # print("-----")
...
def donnees_gaz_2018_2019():
    for annee in range(2018,2020,1):
        df = pd.read_csv(f'data/gaz/donnees_gaz_adresse_{annee}.csv', sep = ';', encoding='utf8')
        inc = 0
...
# def donnees_gaz_2018_2019():
#     for annee in range(2018,2020,1):
#         df = pd.read_csv(f'data/gaz/donnees_gaz_adresse_{annee}.csv', sep = ';', encoding='latin-1')
#         inc = 0
...
# #donnees_gaz_2008_2017()
# #donnees_gaz_2018_2019()
